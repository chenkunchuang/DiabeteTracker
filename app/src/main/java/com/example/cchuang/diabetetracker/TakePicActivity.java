...
public class TakePicActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener,
        Camera.PictureCallback, Camera.ShutterCallback {

    static final String TAG = "DBG_" + TakePicActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d(TAG, "TakePicActivity oncrete");
